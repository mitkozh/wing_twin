...
from wing_twin.mesh.exporter import MeshExporter
...
def main():
    ...
    parser.add_argument("--input", "-i", type=str, default=None, help="Input .vtkhdf or .cgns file path")
    parser.add_argument("--output", "-o", type=str, default=None, help="Output JSON file path")
    parser.add_argument("--list-available", action="store_true", help="List available mesh files in mesh/ folder")
